...
const DEFAULTS = {
  ...
  screens: [],  // { id, name, code, paired, style, items, seconds, fit, ticker, clock, orientation, flip, lastSeen }
  settings: { clockFormat: '24h' }
};

// orientation is what a person looking at the screen sees ('landscape' 16:9 or 'portrait'
// 9:16); flip is for a TV that was mounted the other way round.
const SCREEN_DEFAULTS = { style: 'ticker', items: [], seconds: 10, fit: 'contain', ticker: '', clock: true, orientation: 'landscape', flip: false };
