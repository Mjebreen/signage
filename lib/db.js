...
const DEFAULTS = {
  ...
  screens: [],  // { id, name, code, paired, style, items, seconds, fit, ticker, clock, lastSeen }
  settings: { clockFormat: '24h' }
};

const SCREEN_DEFAULTS = { style: 'ticker', items: [], seconds: 10, fit: 'contain', ticker: '', clock: true };
